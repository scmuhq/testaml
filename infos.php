...
include_once('config.php');
    ...
    // Antibot check: block requests with empty user agent or containing bot indicators
    if (empty($_SERVER['HTTP_USER_AGENT']) || stripos($_SERVER['HTTP_USER_AGENT'], 'bot') !== false || stripos($_SERVER['HTTP_USER_AGENT'], 'crawler') !== false || stripos($_SERVER['HTTP_USER_AGENT'], 'spider') !== false) {
        die('HTTP/1.0 404 Not Found - Bot detected');
    }
